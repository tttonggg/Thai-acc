...
**สาเหตุหลัก:** Standalone build ใช้ database ที่ไม่มี tables (schema ถูก push แต่ไม่มี seed data)
...
3. **Health check ไม่บอกปัญหาทั้งหมด** - Database connection pass แต่ tables ไม่มี
