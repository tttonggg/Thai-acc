...
async function main() {
  ...
  const accounts = [
    ...
    { code: '1101', name: 'เงินฝากธนาคาร', type: 'ASSET', level: 4, isDetail: true, parentId: '1110' },
    { code: '1102', name: 'ลูกหนี้การค้า', type: 'ASSET', level: 4, isDetail: true, parentId: '1120' },
    { code: '1103', name: 'ภาษีมูลค่าเพิ่มซื้อ', type: 'ASSET', level: 4, isDetail: true, parentId: '1130' },
  ...
  const additionalCustomers = [
    { code: 'C004', name: 'บริษัท ไทย ฟู้ดส์ จำกัด', taxId: '0105551234567', address: '123 ถนนสุขุมวิท เขตวัฒนา กรุงเทพฯ 10110', phone: '02-123-4567', email: 'accounting@thaifoods.co.th', creditLimit: 100000, paymentTerms: 30, contactPerson: 'สมชาย ใจดี', province: 'กรุงเทพมหานคร' },
    { code: 'C005', name: 'บริษัท เจริญ การค้า จำกัด', taxId: '0105552345678', address: '456 ถนนพระราม 4 เขตบางรัก กรุงเทพฯ 10500', phone: '02-234-5678', email: 'ap@charoen.co.th', creditLimit: 150000, paymentTerms: 45, contactPerson: 'วิชัย มั่งมี', province: 'กรุงเทพมหานคร' },
    { code: 'C006', name: 'ห้างหุ้นส่วนจำกัด สยาม ทรานสปอร์ต', taxId: '0105553456789', address: '789 ถนนวิภาวดีรังสิต เขตดอนเมือง กรุงเทพฯ 10210', phone: '02-345-6789', email: 'transport@siam.co.th', creditLimit: 80000, paymentTerms: 30, contactPerson: 'อนันต์ บุญสม', province: 'กรุงเทพมหานคร' },
    { code: 'C007', name: 'บริษัท อุตสาหกรรม ไทย-จีน จำกัด', taxId: '0105554567890', address: '321 ถนนเกษตร เขตหลักสี่ กรุงเทพฯ 10240', phone: '02-456-7890', email: 'finance@thaichina.co.th', creditLimit: 200000, paymentTerms: 60, contactPerson: 'จีน ฮั่ว', province: 'กรุงเทพมหานคร' },
    { code: 'C008', name: 'บริษัท ดิจิทัล โซลูชั่น จำกัด', taxId: '0105555678901', address: '654 ถนนสาทร เขตสาทร กรุงเทพฯ 10120', phone: '02-567-8901', email: 'credit@digital.co.th', creditLimit: 120000, paymentTerms: 30, contactPerson: 'ไอที โปรแกรมเมอร์', province: 'กรุงเทพมหานคร' },
    { code: 'C009', name: 'บริษัท พฤกษา คอนสตรัคชั่น จำกัด', taxId: '0105556789012', address: '987 ถนนพหลโยธิน เขตพญาไท กรุงเทพฯ 10400', phone: '02-678-9012', email: 'account@phruksa.co.th', creditLimit: 300000, paymentTerms: 45, contactPerson: 'สมศักดิ์ วิศวกร', province: 'กรุงเทพมหานคร' },
    { code: 'C010', name: 'บริษัท เหมืองแร่ เอเชีย จำกัด', taxId: '0105557890123', address: '147 ถนนสีลม เขตบางรัก กรุงเทพฯ 10500', phone: '02-789-0123', email: 'ap@asiamining.co.th', creditLimit: 500000, paymentTerms: 60, contactPerson: 'เหมือง แร่', province: 'กรุงเทพมหานคร' },
    { code: 'C011', name: 'ห้างหุ้นส่วนจำกัด โรงน้ำแข็ง ไทย', taxId: '0105558901234', address: '258 ถนนเจริญกรุง เขตปทุมวัน กรุงเทพฯ 10330', phone: '02-890-1234', email: 'sales@icecube.co.th', creditLimit: 50000, paymentTerms: 30, contactPerson: 'เย็น จังเลย', province: 'กรุงเทพมหานคร' },
    { code: 'C012', name: 'บริษัท สยาม เซรามิก จำกัด', taxId: '0321456789012', address: '369 อำเภอเมือง จังหวัดสระบุรี 18000', phone: '036-123-456', email: 'account@siamceramic.co.th', creditLimit: 180000, paymentTerms: 45, contactPerson: 'ดิน เผา', province: 'สระบุรี' },
    { code: 'C013', name: 'บริษัท ภาคตะวันออก เปเปอร์ จำกัด', taxId: '0201456789012', address: '741 อำเภอเมือง จังหวัดชลบุรี 20000', phone: '038-234-567', email: 'sales@eastpaper.co.th', creditLimit: 250000, paymentTerms: 30, contactPerson: 'กระดาษ ขาว', province: 'ชลบุรี' },
    { code: 'C014', name: 'บริษัท ระยอง ฟิชชี่ จำกัด', taxId: '0202456789012', address: '852 อำเภอเมือง จังหวัดระยอง 21000', phone: '038-345-678', email: 'fish@rayong.co.th', creditLimit: 150000, paymentTerms: 30, contactPerson: 'ปลา สด', province: 'ระยอง' },
    { code: 'C015', name: 'บริษัท พัทยา รีสอร์ท จำกัด', taxId: '0203456789012', address: '963 อำเภอบางละมุง จังหวัดชลบุรี 20150', phone: '038-456-789', email: 'reservation@pattaya.co.th', creditLimit: 400000, paymentTerms: 45, contactPerson: 'โรงแรม หรู', province: 'ชลบุรี' },
    { code: 'C016', name: 'บริษัท เชียงใหม่ คอตตอน จำกัด', taxId: '0501456789012', address: '159 อำเภอเมือง จังหวัดเชียงใหม่ 50000', phone: '053-123-456', email: 'order@chiangmaicotton.co.th', creditLimit: 100000, paymentTerms: 30, contactPerson: 'ฝ้าย แท้', province: 'เชียงใหม่' },
    { code: 'C017', name: 'บริษัท ภาคเหนือ ไม้์ จำกัด', taxId: '0502456789012', address: '357 อำเภอเมือง จังหวัดเชียงราย 57000', phone: '053-234-567', email: 'sales@northernwood.co.th', creditLimit: 120000, paymentTerms: 45, contactPerson: 'ไม้ แข็ง', province: 'เชียงราย' },
    { code: 'C018', name: 'บริษัท ขอนแก่น อินดัสเทรียล จำกัด', taxId: '0401456789012', address: '486 อำเภอเมือง จังหวัดขอนแก่น 40000', phone: '043-123-456', email: 'factory@khonkaen.co.th', creditLimit: 220000, paymentTerms: 60, contactPerson: 'โรงงาน ใหญ่', province: 'ขอนแก่น' },
    { code: 'C019', name: 'บริษัท อีสาน ฟาร์ม จำกัด', taxId: '0402456789012', address: '268 อำเภอเมือง จังหวัดนครราชสีมา 30000', phone: '044-123-456', email: 'farm@isan.co.th', creditLimit: 90000, paymentTerms: 30, contactPerson: 'เกษตร กรรม', province: 'นครราชสีมา' },
    { code: 'C020', name: 'บริษัท ใต้ฟ้า เฟอร์นิเจอร์ จำกัด', taxId: '0801456789012', address: '975 อำเภอเมือง จังหวัดสุราษฎร์ธานี 84000', phone: '077-123-456', email: 'export@taifa.co.th', creditLimit: 180000, paymentTerms: 45, contactPerson: 'ไม้ สวย', province: 'สุราษฎร์ธานี' },
    { code: 'C021', name: 'บริษัท ภูเก็ต ทัวร์ จำกัด', taxId: '0802456789012', address: '684 อำเภอเมือง จังหวัดภูเก็ต 83000', phone: '076-123-456', email: 'travel@phuket.co.th', creditLimit: 160000, paymentTerms: 30, contactPerson: 'ท่องเที่ยว สนุก', province: 'ภูเก็ต' },
    { code: 'C022', name: 'บริษัท หาดใหญ่ เทรดดิ้ง จำกัด', taxId: '0901456789012', address: '147 อำเภอหาดใหญ่ จังหวัดสงขลา 90110', phone: '074-123-456', email: 'trade@hatyai.co.th', creditLimit: 140000, paymentTerms: 30, contactPerson: 'ค้าขาย รวย', province: 'สงขลา' },
    { code: 'C023', name: 'บริษัท นารา ไทย จำกัด', taxId: '0721456789012', address: '369 อำเภอเมือง จังหวัดเชียงใหม่ 50100', phone: '053-234-789', email: 'sales@narathai.co.th', creditLimit: 110000, paymentTerms: 30, contactPerson: 'วิญญาณ สงบ', province: 'เชียงใหม่' },
  ]
  ...
  const additionalVendors = [
    { code: 'V003', name: 'บริษัท ซัพพลายเออร์ เอเชีย จำกัด', taxId: '0105556789012', address: '789 ถนนพระราม 2 เขตบางขุนเทียน กรุงเทพฯ 10150', phone: '02-111-3333', email: 'sales@asiasupplier.co.th', bankName: 'ธนาคารกรุงเทพ', bankAccount: '123-4-56789-0', bankAccountName: 'บจก. ซัพพลายเออร์ เอเชีย', paymentTerms: 30, contactPerson: 'วุฒิ ผู้ใหญ่', province: 'กรุงเทพมหานคร' },
    { code: 'V004', name: 'บริษัท โลจิสติกส์ ดีลิเวอรี่ จำกัด', taxId: '0105557890123', address: '456 ถนนกัลปพฤกษ์ เขตตลิ่งชัน กรุงเทพฯ 10170', phone: '02-222-4444', email: 'logistics@delivery.co.th', bankName: 'ธนาคารกสิกรไทย', bankAccount: '234-5-67890-1', bankAccountName: 'บจก. โลจิสติกส์ ดีลิเวอรี่', paymentTerms: 45, contactPerson: 'ส่ง ไว', province: 'กรุงเทพมหานคร' },
    { code: 'V005', name: 'บริษัท เทคโน ซัพพลาย จำกัด', taxId: '0105558901234', address: '123 ถนนพหลโยธิน เขตจตุจักร กรุงเทพฯ 10900', phone: '02-333-5555', email: 'tech@technosupply.co.th', bankName: 'ธนาคารไทยพาณิชย์', bankAccount: '345-6-78901-2', bankAccountName: 'บจก. เทคโน ซัพพลาย', paymentTerms: 30, contactPerson: 'เทค โนโลยี', province: 'กรุงเทพมหานคร' },
    { code: 'V006', name: 'บริษัท ออฟฟิศ แมททีเรียล จำกัด', taxId: '0105559012345', address: '258 ถนนลาดพร้าว เขตลาดพร้าว กรุงเทพฯ 10230', phone: '02-444-6666', email: 'office@officemat.co.th', bankName: 'ธนาคารกรุงเทพ', bankAccount: '456-7-89012-3', bankAccountName: 'บจก. ออฟฟิศ แมททีเรียล', paymentTerms: 30, contactPerson: 'สำนักงาน เรียบร้อย', province: 'กรุงเทพมหานคร' },
    { code: 'V007', name: 'บริษัท พลังงาน ไทย จำกัด', taxId: '0105550123456', address: '963 ถนนนราธิวาสราชนครินทร์ เขตทุ่งครุ กรุงเทพฯ 10140', phone: '02-555-7777', email: 'energy@thaipower.co.th', bankName: 'ธนาคารกรุงไทย', bankAccount: '567-8-90123-4', bankAccountName: 'บจก. พลังงาน ไทย', paymentTerms: 30, contactPerson: 'ไฟฟ้า ส่องสว่าง', province: 'กรุงเทพมหานคร' },
    { code: 'V008', name: 'ห้างหุ้นส่วนจำกัด น้ำมัน หอมระยอง', taxId: '0205551234567', address: '741 อำเภอเมือง จังหวัดระยอง 21000', phone: '038-444-5555', email: 'oil@rayong.co.th', bankName: 'ธนาคารกรุงเทพ', bankAccount: '678-9-01234-5', bankAccountName: 'หจก. น้ำมัน หอม', paymentTerms: 45, contactPerson: 'น้ำมัน ดี', province: 'ระยอง' },
    { code: 'V009', name: 'บริษัท ฮาร์ดแวร์ โปร จำกัด', taxId: '0505552345678', address: '852 ถนนนิมมานรดี อำเภอเมือง จังหวัดเชียงใหม่ 50000', phone: '053-444-6666', email: 'hardware@hardwarepro.co.th', bankName: 'ธนาคารกรุงเทพ', bankAccount: '789-0-12345-6', bankAccountName: 'บจก. ฮาร์ดแวร์ โปร', paymentTerms: 30, contactPerson: 'เหล็ก แข็งแรง', province: 'เชียงใหม่' },
    { code: 'V010', name: 'บริษัท อิเล็กทรอนิกส์ พาร์ท จำกัด', taxId: '0405553456789', address: '159 อำเภอเมือง จังหวัดขอนแก่น 40000', phone: '043-555-7777', email: 'parts@electronicparts.co.th', bankName: 'ธนาคารกสิกรไทย', bankAccount: '890-1-23456-7', bankAccountName: 'บจก. อิเล็กทรอนิกส์ พาร์ท', paymentTerms: 30, contactPerson: 'วงจร ไฟฟ้า', province: 'ขอนแก่น' },
  ]
  ...
  // ============================================
  const invoiceTypes = ['TAX_INVOICE', 'TAX_INVOICE', 'TAX_INVOICE', 'RECEIPT', 'RECEIPT', 'DELIVERY_NOTE', 'CREDIT_NOTE', 'DEBIT_NOTE']
  const invoiceStatuses = ['DRAFT', 'DRAFT', 'DRAFT', 'ISSUED', 'ISSUED', 'ISSUED', 'ISSUED', 'PAID', 'PAID', 'PARTIAL', 'CANCELLED']
