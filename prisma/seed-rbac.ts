...
const permissions = [
  ...
  { module: 'purchase_request', action: 'delete', code: 'pr.delete', description: 'ลบใบขอซื้อ' },
  {
    ...
    action: 'approve',
    code: 'pr.approve',
    description: 'อนุมัติใบขอซื้อ',
  },
  {
    module: 'purchase_request',
    action: 'submit',
    code: 'pr.submit',
    description: 'ส่งใบขอซื้อเพื่ออนุมัติ',
  },
  ...
  { module: 'receipt', action: 'read', code: 'receipt.read', description: 'ดูใบเสร็จรับเงิน' },
  {
    ...
    action: 'update',
    code: 'receipt.update',
    description: 'แก้ไขใบเสร็จรับเงิน',
  },
  ...
  // Journal permissions
  {
    ...
    action: 'create',
    code: 'journal.create',
    description: 'สร้างรายการบันทึกบัญชี',
  },
  { module: 'journal', action: 'read', code: 'journal.read', description: 'ดูรายการบันทึกบัญชี' },
  {
    ...
    action: 'post',
    code: 'journal.post',
    description: 'อนุมัติรายการบันทึกบัญชี',
  },
...
const systemRoles = [
  ...
  {
    name: 'ACCOUNTANT',
    description: 'นักบัญชี - เข้าถึงฟังก์ชันบัญชีทั้งหมด',
    type: 'SYSTEM' as const,
  },
  {
    name: 'PROCUREMENT',
    description: 'พนักงานจัดซื้อ - เข้าถึง PR/PO และ GRN',
    type: 'SYSTEM' as const,
  },
