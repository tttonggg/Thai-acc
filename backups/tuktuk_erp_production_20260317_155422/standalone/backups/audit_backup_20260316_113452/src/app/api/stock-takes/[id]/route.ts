...
import { requireAuth, requireRole, apiSuccess, apiError, notFoundError, unauthorizedError, forbiddenError } from '@/lib/api-auth'
import { z } from 'zod'
...
export async function PUT(
  ...
  try {
    ...
    if (body.lines) {
      ...
      return apiSuccess(updatedStockTake)
    }
