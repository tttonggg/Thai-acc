...
test.describe('VOID_REVERSE_PAGINATION - New Feature Tests', () => {
   ...
   */
  test('[VOID-001] Invoice void API endpoint exists and validates input', async ({ page, request }) => {
    console.log('\n==========================================')
   ...
   */
  test('[VOID-002] Journal entry reverse API endpoint exists and validates input', async ({ page, request }) => {
    console.log('\n==========================================')
   ...
   */
  test('[PAGINATION-001] All endpoints enforce max limit of 100 items', async ({ page, request }) => {
    console.log('\n==========================================')
   ...
   */
  test('[PAGINATION-002] Paginated responses include proper metadata', async ({ page, request }) => {
    console.log('\n==========================================')
   ...
   */
  test('[PERFORMANCE-001] Queries return quickly with performance indexes', async ({ page, request }) => {
    console.log('\n==========================================')
    ...
    try {
      const queries = [
        ...
        { path: '/api/invoices?startDate=2024-01-01&endDate=2024-12-31', name: 'Invoices by date range' },
