...
export default function APAgingPage() {
  ...
  const { data, isLoading } = useAPAging({ as_of: asOfDate });
      ...
      <div className="p-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">เจ้าหนี้ Aging</h1>
              <p className="text-gray-500 mt-1">Accounts Payable Aging Report</p>
            </div>
          </div>
