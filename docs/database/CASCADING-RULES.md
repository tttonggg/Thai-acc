...
This document describes all cascading delete and update rules in the Thai Accounting ERP database schema.
...
**Business Rule:** Accounts with transaction history cannot be deleted. Use soft delete (`isActive = false`) instead.
...
**Business Rule:** Posted journal entries cannot be deleted. Must reverse with reversing entry.
...
**Business Rule:** Customers with transaction history cannot be deleted. Use soft delete.
...
**Business Rule:** Vendors with transaction history cannot be deleted. Use soft delete.
...
**Business Rule:** Products with inventory movements cannot be deleted. Archive instead.
...
**Business Rule:** Posted/issued invoices cannot be deleted. Create credit note instead.
...
1. **Always use soft delete** for master data (customers, vendors, products, accounts)
