...
**Task**: 4.1.1 - Document Creation Test Cases **Version**: 1.0 **Last
Updated**: 2026-03-11
...
- Invoice saves but displays warning: "ยอดหนี้เกินวงเงินเครดิต" (Balance exceeds
  credit limit)
...
- Description: "บริการติดตั้งเครื่องทำความเย็น (Air Conditioner) @
  สำนักงานใหญ่ # 001"
