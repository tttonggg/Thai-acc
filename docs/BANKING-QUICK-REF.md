...
- Edit Dialogs: `/src/components/banking/bank-account-edit-dialog.tsx`, `/src/components/banking/cheque-edit-dialog.tsx`

### API Routes
- Bank Accounts: `/src/app/api/bank-accounts/route.ts`, `/src/app/api/bank-accounts/[id]/route.ts`
