...
**Date:** 2026-04-15
**Severity:** CRITICAL
**Impact:** All monetary modules display 100x wrong amounts
...
**Why it happened:** Old code didn't use `bahtToSatang()` when saving. New code uses `satangToBaht()` when loading.
...
totalAmount: isLikelySatang ? satangToBaht(invoice.totalAmount) : invoice.totalAmount
```
...
3. **Check API response:**
   ...
   ```
   **Expected:** `"totalAmount": 1234.56`
   **Wrong:** `"totalAmount": 123456`
...
✅ Invoices - Fixed
✅ Receipts - Uses satangToBaht
✅ Payments - Uses satangToBaht
✅ Purchase Invoices - Uses satangToBaht
✅ Purchase Orders - Uses satangToBaht
✅ Quotations - Uses satangToBaht
✅ Credit Notes - Uses satangToBaht
✅ Debit Notes - Uses satangToBaht
