...
**Narrator:**
"สวัสดีครับ/ค่ะ ในตอนนี้เราจะมาเรียนรู้การบันทึกการรับเงินจากลูกค้า ซึ่งเป็นขั้นตอนสำคัญในการปิดการขายและติดตามลูกหนี้"
...
**Narrator:**
"เมื่อลูกค้าชำระเงินตามใบกำกับภาษีที่ส่งให้ เราต้องบันทึกใบเสร็จรับเงินเพื่อ"
...
**Narrator:**
"ไปที่เมนู ใบเสร็จรับเงิน เราจะเห็นรายการใบเสร็จทั้งหมด"
...
**Narrator:**
"คลิกที่ปุ่ม สร้างใบเสร็จรับเงินใหม่"
...
**Narrator:**
"เมื่อเลือกลูกค้า ระบบจะแสดงใบกำกับภาษีที่ค้างชำระทั้งหมด"
...
**Narrator:**
"เลือกใบกำกับภาษีที่ต้องการจัดสรร ในตัวอย่างนี้ลูกค้าชำระใบแรกเต็มจำนวน"
...
**Narrator:**
"กรอกจำนวนเงินที่รับชำระ ถ้าชำระเต็มจำนวน ยอดคงเหลือจะเป็นศูนย์"
...
**Narrator:**
"บันทึกใบเสร็จ สถานะจะเป็น ฉบับร่าง (Draft)"
...
**Narrator:**
"หลังจากบันทึกแล้ว เราต้อง โพสต์ (Post) เพื่อบันทึกบัญชี"
...
**Narrator:**
"ระบบสร้างรายการบัญชีโดยอัตโนมัติ เพิ่มเงินในธนาคาร และลดลูกหนี้"
...
**Narrator:**
"ในกรณีที่ลูกค้าชำระบางส่วน เราสามารถบันทึกได้เช่นกัน"
...
**Narrator:**
"ลูกค้าชำระ 30,000 บาท จากยอด 53,500 บาท เหลือค้างชำระ 23,500 บาท"
...
**Narrator:**
"บางครั้งลูกค้าหักภาษี ณ ที่จ่ายไว้ เช่น ค่าบริการต้องหัก 3%"
...
**Narrator:**
"เลือกประเภทเอกสารและรายได้ ระบบจะคำนวณอัตราภาษีอัตโนมัติ"
...
**Narrator:**
"ภาษีหัก ณ ที่จ่ายจะถูกบันทึกเป็นสินทรัพย์ ใช้หักภาษีเงินได้สิ้นปี"
...
**Narrator:**
"ลูกค้าสามารถชำระหลายใบกำกับภาษีในครั้งเดียว"
...
**Narrator:**
"เลือกหลายใบกำกับภาษีและกรอกจำนวนที่รับชำระในแต่ละใบ"
...
**Narrator:**
"ระบบมีรายงานเกี่ยวกับการรับเงินหลายรูปแบบ"
...
**Narrator:**
"สามารถส่งออกรายงานเป็น Excel หรือ PDF เพื่อวิเคราะห์ต่อไป"
...
**Narrator:**
"ในตอนนี้คุณได้เรียนรู้การบันทึกใบเสร็จรับเงินครบถ้วนแล้ว ต่อไปเราจะเรียนรู้การบันทึกการจ่ายเงินให้ผู้ขาย"
...
**Next Episode:**
"ตอนหน้าเราจะเรียนรู้การบันทึกใบสำคัญจ่ายและการจัดการเจ้าหนี้"
