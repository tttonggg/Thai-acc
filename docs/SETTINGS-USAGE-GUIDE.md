...
The Settings component (ตั้งค่า) allows you to configure all aspects of the Thai Accounting ERP system, including company information, document numbering, and tax rates.
...
**Note:** These rates are used as defaults when creating invoices, payments, etc. You can override them on individual documents.
...
**Warning:** Importing will add data to your database. Make sure to backup before importing!
