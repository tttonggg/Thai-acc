...
This guide shows how to integrate Excel export functionality into report pages in the Thai Accounting ERP system.
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b">
                <th className="text-left p-2">รหัสบัญชี</th>
            ...
            <tbody>
              ...
              <tr className="border-b-2 font-bold bg-gray-50">
      ...
      {data && (
        <Card>
          <CardContent className="pt-6">
            {/* Revenue Section */}
            <h2 className="text-lg font-bold mb-3">รายได้</h2>
            ...
            <div className="flex justify-between py-2 px-4 border-b-2 font-bold bg-blue-50">
              <span>รวมรายได้</span>
              <span className="font-mono">
            ...
            {/* Expenses Section */}
            <h2 className="text-lg font-bold mb-3 mt-6">ค่าใช้จ่าย</h2>
            ...
            {/* Net Income */}
            <div className="flex justify-between py-3 px-4 mt-4 font-bold text-lg bg-yellow-50">
              <span>
                {data.netIncome >= 0 ? 'กำไรสุทธิ' : 'ขาดทุนสุทธิ'}
              </span>
              <span className="font-mono">
          ...
          <div>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex justify-between py-2 px-4 mt-4 font-bold bg-green-50">
...
1. **Always provide meaningful filenames** that include the report type and date range
...
- [EXCEL-EXPORT-SERVICE.md](./EXCEL-EXPORT-SERVICE.md) - Complete service documentation
