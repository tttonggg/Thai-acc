...
## Thai Accounting ERP - Video Training Series

**Version:** 1.0.0  
**Total Videos:** 15  
**Target Audience:** Thai SME Business Owners, Accountants, Bookkeepers
...
3. Highlight quick action buttons
...
[Call to Action]
Subscribe for more tutorials | Next Video Link | Support Link
```
...
2. Enter company name (Thai and English)
3. Input Tax ID (เลขประจำตัวผู้เสียภาษี)
4. Fill in complete address
5. Upload company logo
6. Save changes

[Narration points]
- Tax ID is required for tax reports
- Address appears on invoices
- Logo appears on printed documents
```
...
2. Assigning roles (ADMIN, ACCOUNTANT, USER, VIEWER)
...
2. Liabilities (2000-2999) - หนี้สิน
3. Equity (3000-3999) - ทุน
4. Revenue (4000-4999) - รายได้
5. Expenses (5000-5999) - ค่าใช้จ่าย

[Show examples]
- 1101: เงินสด (Cash)
- 1201: ลูกหนี้การค้า (Accounts Receivable)
- 2101: เจ้าหนี้การค้า (Accounts Payable)
- 4101: รายได้ขาย (Sales Revenue)
```
...
- Level 2: Groups (11xx)
- Level 3: Control accounts (110x)
- Level 4: Detail accounts (1101-01)

[Demo]
Show how posting to detail account rolls up to summary
```
...
Live demo:
1. Click "New Account"
2. Enter account code
3. Enter Thai and English names
4. Select account type
5. Choose parent account
6. Mark as detail account
7. Save
...
- Which for expenses?
- How accounts appear in reports
```
...
2. Products/services should be set up
3. Understand VAT implications

[Quick demo]
Show how to quickly add a new customer if needed
```
...
3. Verify invoice date and due date
4. Enter reference number (PO number)
5. Add line items:
...
[Demo]
Click Issue → Show confirmation → View journal entry
```
...
2. Export PDF
3. Email to customer
4. Download tax invoice format

[Show]
Different print formats available
```
...
2. New Receipt
3. Select customer
4. System shows unpaid invoices
5. Enter payment amount per invoice
6. Select payment method
7. Enter reference (cheque number, transfer ref)
8. Handle withholding tax if applicable
9. Save and post
```
...
2. Reference number
3. Description
4. Line-by-line entry
5. Debit/Credit balancing
6. Validation
7. Posting
```
