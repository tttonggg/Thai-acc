...
**A:** Thai Accounting ERP คือโปรแกรมบัญชีบนคลาวด์ที่ออกแบบมาสำหรับธุรกิจ SME
ไทย รองรับมาตรฐานบัญชีไทย (TFRS) และกฎหมายภาษีไทยทั้งหมด รวมถึง VAT 7%, ภาษีหัก
ณ ที่จ่าย และประกันสังคม
...
**A:** ระบบรองรับผู้ใช้งานไม่จำกัดจำนวน โดยสามารถกำหนดสิทธิ์แต่ละผู้ใช้ได้
...
**A:** ระบบมีให้ใช้งานฟรีสำหรับการทดลอง
สำหรับการใช้งานจริงมีแพ็กเกจหลายระดับเริ่มต้นที่ 499 บาท/เดือน
...
**A:** ไม่ต้องติดตั้ง ระบบทำงานผ่านเว็บเบราว์เซอร์ รองรับ Chrome, Firefox,
Safari, Edge

### Q8: รองรับมือถือหรือไม่?

**A:** รองรับการใช้งานผ่านมือถือและแท็บเล็ต
แต่แนะนำใช้คอมพิวเตอร์สำหรับงานที่ซับซ้อน

### Q9: ต้องการความรู้ด้านบัญชีหรือไม่?

**A:** มีความรู้พื้นฐานด้านบัญชีจะช่วยให้ใช้งานได้เต็มประสิทธิภาพ
แต่ระบบมีคู่มือและตัวอย่างให้ติดตาม

### Q10: มีการอบรมการใช้งานหรือไม่?

**A:** มีวิดีโอสอนการใช้งานครบทุกฟีเจอร์
นอกจากนี้ยังมีการอบรมออนไลน์สำหรับองค์กร
...
**A:** ติดต่อผู้ดูแลระบบเพื่อปลดล็อก หรือรอ 30
นาทีหลังจากพยายามเข้าระบบผิดหลายครั้ง
...
- การส่งออก (Export)
- สินค้า/บริการที่ได้รับยกเว้น ต้องมีเอกสารประกอบตามกฎหมาย
...
**A:** ไม่จำเป็นต้องต่างกันเสมอไป กรณีได้รับเงินพร้อมออกใบกำกับภาษี
ใบกำกับภาษีนั้นเองก็เป็นใบเสร็จได้
...
1. ตั้งค่า → สำรองและกู้คืนข้อมูล
2. เลือกไฟล์สำรอง
3. ยืนยันการกู้คืน ⚠️ **คำเตือน**: การกู้คืนจะแทนที่ข้อมูลปัจจุบัน

### Q71: ส่งออกข้อมูลเป็น Excel ได้หรือไม่?

**A:** ได้ ทุกหน้ารายการมีปุ่ม "ส่งออก"
สามารถเลือกส่งออกทั้งหมดหรือเฉพาะที่เลือก
