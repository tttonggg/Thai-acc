...
We needed to choose a frontend framework for the Thai Accounting ERP system. The
system is a complex web application with:
...
- **Server/Client boundaries**: Need to understand when to use Server vs Client
  components
