...
**Purpose**: Identify all monetary fields storing Baht as Float (incorrect) vs Satang as Int (correct)

---

## Executive Summary

**TOTAL MODELS AUDITED**: 71 models
**MODELS WITH MONETARY FIELDS**: 28 models
...
**Status**: ✅ **ACCEPTABLE** - Exchange rates are multipliers (e.g., 35.5 THB/USD), not monetary amounts. Float is correct here.

---

## Float Fields That Are Correct (Percentages/Rates)

These fields correctly use `Float` because they store percentages or rates, NOT Baht amounts:
...
**Impact**: These bugs cause factor-of-100 errors in purchase orders and requests.
...
**Bad News**: PurchaseRequestLine and PurchaseOrderLine have 8 fields storing Baht as `Float`, causing factor-of-100 errors.
...
3. Invoice (7): subtotal, vatAmount, totalAmount, discountAmount, withholdingAmount, netAmount, paidAmount, foreignAmount
...
9. PurchaseInvoice (7): subtotal, vatAmount, totalAmount, discountAmount, withholdingAmount, netAmount, paidAmount
