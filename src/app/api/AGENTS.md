...
Next.js API route handlers (64 route directories, 173+ endpoints) for the Thai
...
All amounts in Satang (integer). Use `bahtToSatang()` on input, `satangToBaht()`
on output.
