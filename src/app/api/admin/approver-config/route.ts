...
export async function GET() {
  try {
    ...
    return NextResponse.json({ success: false, error: 'Failed to fetch approver configs' }, { status: 500 })
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { documentType, condition, approverType, approverId, approverDepartmentId, approvalOrder } = body
    ...
    return NextResponse.json({ success: false, error: 'Failed to create approver config' }, { status: 500 })
  }
}
...
export async function PUT(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ success: false, error: 'Failed to update approver config' }, { status: 500 })
  }
}
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ success: false, error: 'Failed to delete approver config' }, { status: 500 })
  }
}