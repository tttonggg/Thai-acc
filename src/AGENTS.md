...
Main application source code directory for the Thai Accounting ERP system (Keerati).
...
5. **Zod validation**: All API inputs validated via schemas in `lib/validations.ts`
