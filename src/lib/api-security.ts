 ...
 */
export function verifyWebhookRequest(req: NextRequest, payload: string, secret: string): boolean {
 ...
 */
export function parseAuthorizationHeader(req: NextRequest): { type: string; token: string } | null {
