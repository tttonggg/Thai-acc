 ...
 * Update a quotation
 */
export async function updateQuotation(id: string, data: QuotationUpdateInput): Promise<any> {
 ...
 */
export async function deleteQuotation(id: string, deletedBy?: string): Promise<any> {
 ...
 */
export async function convertToSalesOrder(id: string, salesOrderId: string): Promise<any> {
  const quotation = await prisma.quotation.findUnique({ where: { id } });
