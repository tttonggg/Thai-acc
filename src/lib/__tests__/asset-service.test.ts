...
describe('Asset Service', () => {
  ...
  describe('postMonthlyDepreciation', () => {
    ...
    it('should throw error if schedule not found', async () => {
      ...
      await expect(postMonthlyDepreciation('nonexistent')).rejects.toThrow('Schedule not found');
    });
    ...
    it('should throw error if already posted', async () => {
      ...
      await expect(postMonthlyDepreciation('sched-1')).rejects.toThrow('Already posted');
    });
