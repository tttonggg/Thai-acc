...
describe('Thai Accounting Utilities', () => {
  describe('ACCOUNT_TYPES', () => {
    it('should define all account types correctly', () => {
      ...
      expect(ACCOUNT_TYPES.LIABILITY).toEqual({
        code: '2',
        name: 'หนี้สิน',
        nameEn: 'Liabilities',
      });
      expect(ACCOUNT_TYPES.EQUITY).toEqual({
        code: '3',
  ...
  describe('numberToThaiText', () => {
    ...
    it('should handle complex numbers', () => {
      ...
      expect(numberToThaiText(1234567)).toBe(
  ...
  describe('calculateAging', () => {
    ...
    it('should handle partially paid transactions', () => {
      const asOfDate = new Date('2024-03-31');
      const transactions = [{ date: new Date('2024-03-01'), amount: 10000, paidAmount: 6000 }];
    ...
    it('should ignore fully paid transactions', () => {
      const asOfDate = new Date('2024-03-31');
      const transactions = [{ date: new Date('2024-03-01'), amount: 10000, paidAmount: 10000 }];
    ...
    it('should use current date when asOfDate not provided', () => {
      const transactions = [{ date: new Date(), amount: 1000, paidAmount: 0 }];
