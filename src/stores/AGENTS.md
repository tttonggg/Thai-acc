...
Zustand v5 global state management stores for the Thai Accounting ERP
application.
...
Each role has progressively fewer permissions. The PERMISSIONS object maps each
module to allowed roles.
