...
export function formatNumberWithPreferences(value: number, preferences: UserPreferences): string {
  ...
  if (thousandSeparator !== ',' || decimalSeparator !== '.') {
    return formatted.replace(/,/g, thousandSeparator).replace(/\./g, decimalSeparator);
  }
