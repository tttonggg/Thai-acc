...
## Purpose
Fixed asset lifecycle management — asset registration, depreciation calculation (straight-line, declining balance), disposal, and GL posting for depreciation expense.
...
- Declining balance: depreciation = book value × rate (rate = 1/useful life × multiplier)
      ...
      data: {
        ...
        lines: {
          create: [
            ...
            ...(gainLoss !== 0 ? [{
              accountId: gainLoss > 0 ? gainOnDisposalAccount : lossOnDisposalAccount,
...
const ASSET_CATEGORIES = [
  { code: 'BLDG', name: 'อาคารสถานที่', usefulLife: 40, method: 'STRAIGHT_LINE' },
  { code: 'MACH', name: 'เครื่องจักร', usefulLife: 10, method: 'DECLINING_BALANCE_200' },
  { code: 'VEHI', name: 'ยานพาหนะ', usefulLife: 5, method: 'DECLINING_BALANCE_150' },
  { code: 'EQUIP', name: 'อุปกรณ์', usefulLife: 5, method: 'DECLINING_BALANCE_150' },
  { code: 'COMP', name: 'คอมพิวเตอร์', usefulLife: 4, method: 'DECLINING_BALANCE_200' }
]
```
