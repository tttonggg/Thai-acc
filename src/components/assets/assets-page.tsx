...
import { Building2, Calendar, Plus, TrendingDown } from 'lucide-react'
              ...
              {assets.length === 0
                ...
                : assets.map(a => (
                  <TableRow key={a.id}>
                    ...
                    <TableCell className="text-center"><Badge variant={a.isActive ? 'default' : 'secondary'} className="text-xs">{a.isActive ? 'ใช้งาน' : 'ปลดระวาง'}</Badge></TableCell>
                  </TableRow>
                ))}
            </TableBody>
          </Table>
