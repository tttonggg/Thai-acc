...
import { calculateSSC, calculatePND1 } from '@/lib/payroll-service';

import { generateDepreciationSchedule, getAssetNetBookValue } from '@/lib/asset-service';

import { calculateEmployeePayroll, calculateEmployerSSC } from '@/lib/payroll-service';

import { recordStockMovement, calculateCOGS } from '@/lib/inventory-service';
