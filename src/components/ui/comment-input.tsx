  ...
  return (
    <div
      className={cn(
        ...
        isInternal && "bg-amber-50 border-amber-200 dark:bg-amber-950 dark:border-amber-800"
      )}
    >
      {/* Internal Comment Indicator */}
      {isInternal && (
        <div className="flex items-center gap-1.5 px-3 py-1.5 border-b border-amber-200 dark:border-amber-800 bg-amber-100/50 dark:bg-amber-900/20 rounded-t-lg">
      ...
      <div className="relative">
        <Textarea
          ...
          rows={4}
          className={cn(
            "resize-none border-0 focus-visible:ring-0 rounded-t-none",
        ...
        <div className="px-3 py-2 border-t">
          <div className="flex flex-wrap gap-2">
            {attachments.map((file, index) => (
              <div
                key={index}
                className="flex items-center gap-2 px-2 py-1 bg-accent rounded-md text-sm"
              >
