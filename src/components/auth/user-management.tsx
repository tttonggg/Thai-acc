...
const roleIcons: Record<string, React.ReactNode> = {
  ...
  ACCOUNTANT: <ShieldCheck className="h-4 w-4" />,
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600">จัดการบัญชีผู้ใช้และสิทธิ์การเข้าถึงระบบ</p>
        </div>
        <Button
          onClick={() => {
            resetForm();
      ...
      <Card>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="py-8 text-center text-gray-500">ไม่พบข้อมูลผู้ใช้</div>
          ) : (
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableRow key={user.id}>
                    <TableCell>
                      <div className="flex items-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 font-medium text-white">
                    ...
                    <TableCell>
                      <Badge variant={user.isActive ? 'default' : 'secondary'}>
                        {user.isActive ? (
                          <>
                            <Unlock className="mr-1 h-3 w-3" /> ใช้งานได้
                          </>
                        ) : (
                          <>
                            <Lock className="mr-1 h-3 w-3" /> ปิดการใช้งาน
                          </>
                        )}
                      </Badge>
                    </TableCell>
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>แก้ไขข้อมูลผู้ใช้ {selectedUser?.email}</DialogDescription>
          </DialogHeader>
