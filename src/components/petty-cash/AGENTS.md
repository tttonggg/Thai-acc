...
Petty cash fund management — fund creation, voucher processing, replenishment,
expense tracking, and GL posting for small cash expenses.
    ...
    data: {
      ...
      lines: {
        create: [
          ...
          {
            accountId: replenishment.bankAccountId,
            debit: 0,
