...
Complete React UI layer organization for the Thai Accounting ERP system. This
directory contains all UI components organized by feature modules, shared
utilities, and layout components.
...
- **Feature-based**: Components organized by business domain (e.g., `invoices/`,
  `payments/`)
