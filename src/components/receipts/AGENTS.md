...
## Purpose
Payment receipt processing — recording customer payments, allocating to invoices, handling multiple payment methods (cash, cheque, transfer), and bank reconciliation. Second-most modified module (43+ edits).
...
const unallocatedAmount = receiptAmount - allocations.reduce(
