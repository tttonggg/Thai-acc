...
Chart of accounts (COA) maintenance — account CRUD operations, account
hierarchy, account types (asset, liability, equity, revenue, expense), and Thai
standard account codes (181 accounts).
