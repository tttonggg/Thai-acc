...
## Purpose
Customer invoice lifecycle management — creation, editing, posting to GL, payment allocation, PDF generation, and audit trail. This is the most frequently modified module (112+ edits) and the primary revenue entry point.
