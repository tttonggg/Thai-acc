...
Thai withholding tax (WHT) processing — PND 53 (income), PND 3 (payment to
companies), PND 3A (payment to individuals), certificate generation, and tax
filing support.
...
- Certificates: PND 53 (income received), PND 3 (paid to companies), PND 3A
  (paid to individuals)
