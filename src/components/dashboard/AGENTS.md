...
Main dashboard widgets, layouts, and customization options for the Thai
Accounting ERP home screen.
...
Dashboard data refreshes every 5 minutes via TanStack Query with stale time
configuration.
