      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4">
          {systemRoles.map((role) => (
            <div
              key={role.id}
              className={`rounded-lg border p-4 ${selectedRole?.id === role.id ? 'border-blue-500 bg-blue-50' : 'border-gray-200'}`}
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm text-gray-500">{role._count.employeeRoles} ผู้ใช้</div>
              </div>

              {selectedRole?.id === role.id && (
                <div className="mt-4 border-t pt-4">
                  <p className="mb-2 text-sm font-medium">สิทธิ์ในบทบาทนี้:</p>
