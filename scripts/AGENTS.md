...
This file provides essential guidance for AI coding agents working on the
**Scripts Directory** of the Thai Accounting ERP System. The scripts directory
contains automation utilities for deployment, backup, testing, and security
operations.
...
1. **Deployment & Production Management** - Production deployment and server
   management scripts
...
**Parent Reference**: See `../AGENTS.md` for comprehensive project
documentation.
...
- **Usage**:
  `./scripts/backup/backup-database.sh [full|incremental|list|restore|verify]`
- **Commands**:
...
- **Patterns Scanned**: API keys, AWS keys, JWT secrets, passwords, database
  URLs
...
All scripts support configuration through environment variables and
configuration files:
...
**Related Documentation**: See `../AGENTS.md` for comprehensive project
documentation
