...
**Problem:** Database contained old data in wrong format (Baht instead of Satang)  
...
**Problem:** Dashboard API returned Satang as Baht (2319873 → showed as ฿33.277)  
...
**Before:**
```typescript
revenue: { amount: revenue }  // ❌ Returns Satang (2319873)
```

**After:**
```typescript
revenue: { amount: satangToBaht(revenue) }  // ✅ Returns Baht (23198.73)
```
...
✅ **Prevents cumulative errors** - Multiple calculations don't compound rounding errors
