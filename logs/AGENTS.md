...
## Purpose
Application log files including dev server logs, test logs, and scheduled task logs.
...
### Log Rotation
Logs grow over time. For production, consider log rotation to prevent disk space issues.
