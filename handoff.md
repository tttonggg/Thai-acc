...
Gap analysis vs Technical Specification (ERP architecture doc) reveals **6 critical gaps**. This document tracks remediation work.
...
- [x] Task 1: Audit trail fields (createdById, updatedById, versionNo — 10 models)
