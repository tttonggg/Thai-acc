...
test.describe('Core Financial Modules', () => {
  test('Dashboard module loads with all components', async () => {
    ...
    await page.screenshot({
      path: 'test-results/screenshots/finance/dashboard-overview.png',
      fullPage: true,
    });
  ...
  test('Chart of Accounts module loads with all buttons', async () => {
    ...
    // Take screenshot
    await page.screenshot({
      path: 'test-results/screenshots/finance/accounts-tree.png',
      fullPage: true,
    });
  ...
  test('Journal Entries module loads with all form elements', async () => {
    ...
    const descriptionInput = page
      .locator('textarea#description, textarea[placeholder*="รายการ"]')
      .first();
    ...
    const accountSelectors = page
      .locator('[role="combobox"], button:has-text("เลือกบัญชี")')
      .first();
    ...
    // Take screenshot
    await page.screenshot({
      path: 'test-results/screenshots/finance/journal-form.png',
      fullPage: true,
    });
  ...
  test('Reports module loads with all report options', async () => {
    ...
    // Take screenshot
    await page.screenshot({
      path: 'test-results/screenshots/finance/reports-list.png',
      fullPage: true,
    });
