...
test.describe('Invoice Creation', () => {
  ...
  test('should create a new tax invoice successfully', async ({ page }) => {
    ...
    const createButton = page
      .locator('button:has-text("สร้าง"), button:has-text("สร้างใบกำกับภาษี"), a:has-text("สร้าง")')
      .first();
    ...
    const customerInput = page
      .locator('input[id*="customer"], input[id*="Customer"], input[placeholder*="ลูกค้า"]')
      .first();
    ...
    const descriptionInput = page
      .locator('input[id*="description"], input[placeholder*="รายการ"]')
      .first();
    ...
    const quantityInput = page
      .locator('input[id*="quantity"], input[placeholder*="จำนวน"]')
      .first();
