  ...
  test('direct API test: check response structure', async ({ request }) => {
    ...
    try {
      ...
      try {
        ...
        if ('data' in cnJson) {
          console.log(
            'Credit Notes data type:',
            Array.isArray(cnJson.data) ? 'array' : typeof cnJson.data
          );
        }
      } catch (e) {
      ...
      try {
        ...
        if ('data' in dnJson) {
          console.log(
            'Debit Notes data type:',
            Array.isArray(dnJson.data) ? 'array' : typeof dnJson.data
          );
        }
      } catch (e) {
