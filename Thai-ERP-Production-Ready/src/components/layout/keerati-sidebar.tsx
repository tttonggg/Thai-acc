...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'invoices', label: 'ใบกำกับภาษี', icon: Receipt },
      { id: 'credit-notes', label: 'ใบลดหนี้', icon: FileText },
    ],
  },
  {
    id: 'purchase',
    ...
    items: [
      { id: 'vendors', label: 'ผู้ขาย', icon: Truck },
      { id: 'purchase-requests', label: 'ใบขอซื้อ (PR)', icon: FileText },
      { id: 'purchase-orders', label: 'ใบสั่งซื้อ (PO)', icon: ShoppingCart },
      { id: 'purchases', label: 'ใบซื้อ', icon: Receipt },
      { id: 'payments', label: 'ใบจ่ายเงิน', icon: CreditCard },
      { id: 'debit-notes', label: 'ใบเพิ่มหนี้', icon: FileText },
    ],
  },
  {
    id: 'inventory',
    ...
    items: [
      ...
      { id: 'warehouses', label: 'คลังสินค้า', icon: Building2 },
    ],
  },
  {
    id: 'accounting',
    ...
    color: 'text-blue-500',
    items: [
      { id: 'accounts', label: 'ผังบัญชี', icon: BookOpen },
      { id: 'journal', label: 'บันทึกบัญชี', icon: FileText },
      { id: 'banking', label: 'ธนาคาร', icon: Building2 },
      { id: 'assets', label: 'ทรัพย์สิน', icon: Hammer },
      { id: 'petty-cash', label: 'เงินสดย่อย', icon: Wallet },
    ],
  },
  {
    id: 'tax',
    ...
    items: [
      { id: 'vat', label: 'ภาษีมูลค่าเพิ่ม', icon: Percent },
      { id: 'wht', label: 'ภาษีหัก ณ ที่จ่าย', icon: Landmark },
    ],
  },
  {
    id: 'hr',
    ...
    color: 'text-cyan-500',
    items: [
      { id: 'payroll', label: 'เงินเดือน', icon: Users },
      { id: 'employees', label: 'พนักงาน', icon: UserCog },
    ],
  },
  {
    id: 'reports',
    ...
    items: [
      { id: 'reports', label: 'รายงานทั้งหมด', icon: BarChart3 },
      { id: 'accounting-periods', label: 'งวดบัญชี', icon: Calendar },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'users', label: 'จัดการผู้ใช้', icon: UserCog, adminOnly: true },
      { id: 'entities', label: 'บริษัทในเครือ', icon: Building, adminOnly: true },
      { id: 'currencies', label: 'สกุลเงิน', icon: DollarSign, adminOnly: true },
    ],
  },
]
